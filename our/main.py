...
best_epoch = 0
MAX_EPOCH = 50
my_print("Isa 256*256 batch_size = 4 , 0.4均分  1e-5")
...
for epoch in range(MAX_EPOCH):
    ...
    with torch.no_grad():
        ...
        plt.show()
        plt.savefig("/home/xuzhiwen/pythonProject/modify/gk-confusion"+str(epoch+1)+".pdf", dpi=300)
