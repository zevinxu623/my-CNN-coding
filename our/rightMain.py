...
SAVE_PATH = '/home/xuzhiwen/pythonProject/our/log1'
# save_path = os.path.join(SAVE_PATH, "log-inception-ours-4.txt")
# save_path = os.path.join(SAVE_PATH, "inception-gk-nonpre-1.txt")
save_path = os.path.join(SAVE_PATH, "isa-tcia-256-1.txt")
save_path2 = os.path.join(SAVE_PATH, "isa-tcia-mertic-256-1.txt")
...
rec = [0.0, 0.0, 0.0]
f1 = [0.0, 0.0, 0.0]
my_print("isa 256*256 batch_size = 8 , 0.4均分  1e-5", save_path)
scheduler = torch.optim.lr_scheduler.LambdaLR(optimizer, lr_lambda=(lambda epoch: 0.6 ** (epoch//5)))
