...
from vgg.vgg16 import vgg19_bn
...
SAVE_PATH = '/home/xuzhiwen/pythonProject/vgg/Log'
SAVE_PATH2 = '/home/xuzhiwen/pythonProject/transformer/log'
# save_path = os.path.join(SAVE_PATH, "log-inception-ours-4.txt")
# save_path = os.path.join(SAVE_PATH, "inception-gk-nonpre-1.txt")
save_path = os.path.join(SAVE_PATH, "vgg-1.txt")
save_path2 = os.path.join(SAVE_PATH2, "trans-our-mertic-256-1.txt")
...
rec = [0.0, 0.0, 0.0]
f1 = [0.0, 0.0, 0.0]
my_print("vgg19_bn 512*512 batch_size = 8 ,vgg19_bn 0.2均分  1e-5", save_path)
# scheduler = torch.optim.lr_scheduler.LambdaLR(optimizer, lr_lambda=(lambda epoch: 0.85 ** (epoch//20)))
...
# =========================================================================
        ...
        # plt.savefig("/home/xuzhiwen/pythonProject/right/metric/isa/gk-isa-pr-"+str(epoch+1)+".png")
...
#=================================混淆矩阵===================================
        ...
        # # plt.show()
        # plt.savefig("/home/xuzhiwen/pythonProject/our/log/gk-256-confusion"+str(epoch+1)+".pdf", dpi=300)
# =========================================================================
