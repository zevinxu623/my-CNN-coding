...
best_epoch = 0
MAX_EPOCH = 50
my_print("vgg16 256*256 batch_size = 8 , 0.4均分  1e-5")
scheduler = torch.optim.lr_scheduler.LambdaLR(optimizer, lr_lambda=(lambda epoch: 0.85 ** (epoch//5)))
# scheduler = torch.optim.lr_scheduler.LambdaLR(optimizer, lr_lambda=(lambda epoch: 0.8 ** (epoch//2)))
...
for epoch in range(MAX_EPOCH):
    ...
    with torch.no_grad():
        ...
        # plt.show()
        plt.savefig("/home/xuzhiwen/pythonProject/spe/vgg/gk-confusion" + str(epoch + 1) + ".png", dpi=300)
