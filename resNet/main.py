...
save_path = os.path.join(SAVE_PATH, "compare-gk-pre-resnet-1.txt")
...
optimizer = torch.optim.Adam(model.parameters(), lr=1e-4, weight_decay=0.96)
# scheduler = torch.optim.lr_scheduler.LambdaLR(optimizer, lr_lambda=(lambda epoch: 0.85 ** (epoch//3)))


best_acc = 0.0
best_epoch = 0
MAX_EPOCH = 50
my_print("resnet18 256*256 batch_size = 8 , 0.4均分  1e-4")
