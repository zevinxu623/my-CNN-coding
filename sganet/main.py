...
SAVE_PATH = '/home/xuzhiwen/pythonProject/sganet/Log'
# save_path = os.path.join(SAVE_PATH, "log-sganet-gg-12.txt")
save_path = os.path.join(SAVE_PATH, "log-new-2.txt")
...
transformation2 = transforms.Compose([transforms.Resize((256, 256)),
                                      ...
                                      transforms.ToTensor(),
                                      transforms.Normalize([0.5, 0.5, 0.5], [0.5, 0.5, 0.5])])
# dataset_train = ImageFolder(r"/home/xuzhiwen/ct-archive/Data/train", transform=transformation1)
# dataset_test = ImageFolder(r"/home/xuzhiwen/ct-archive/Data/test", transform=transformation2)

# dataset_train = ImageFolder(r"/home/xuzhiwen/data/ct-archive/Data/test", transform=transformation1)
# dataset_test = ImageFolder(r"/home/xuzhiwen/data/ct-archive/Data/test", transform=transformation2)
...
my_print("new batch_size = 4 , 0.4均分 预训练  1e-5")
