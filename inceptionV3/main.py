...
best_epoch = 0
MAX_EPOCH = 250
my_print("inc 512*512 batch_size = 4 , 0.4均分  1e-5")
# scheduler = torch.optim.lr_scheduler.LambdaLR(optimizer, lr_lambda=(lambda epoch: 0.7 ** (epoch//6)))
...
for epoch in range(MAX_EPOCH):
    ...
    with torch.no_grad():
        ...
        # # plt.show()
        # plt.savefig("/home/xuzhiwen/pythonProject/spe/inception/confusion"+str(epoch+1)+".png", dpi=300)
