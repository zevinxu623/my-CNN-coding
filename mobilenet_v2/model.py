...
from mobilenet_v2.cbam import CBAM
...
def headCount_inceptionv3(pretrained=True, **kwargs):
...
class Inception3(nn.Module):
    ...
    def __init__(self, num_classes=3, aux_logits=False, transform_input=False):
        ...
        self.lconv5 = nn.Conv2d(192, 1, kernel_size=1, stride=1, padding=0, bias=False)
    ...
    def forward(self, x):
        ...
        # y = x1 + density_map3
        #
        # output = torch.flatten(y, start_dim=1)
