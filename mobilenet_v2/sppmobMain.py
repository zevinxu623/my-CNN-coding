...
from mobilenet_v2.sppmob import mobilenet_v2
...
save_path = os.path.join(SAVE_PATH, "mob-c-spp-8.txt")
...
rec = [0.0, 0.0, 0.0]
f1 = [0.0, 0.0, 0.0]
my_print("mob spp se  512*512 batch_size = 8 , 0.4均分  8.1e-5", save_path)
